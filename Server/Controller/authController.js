...
const sendEmail = async (email, message, username) => {
  const htmlContent = `
    ...
    <body>
        <div class="container">
            <div class="title">
                <a href="http://127.0.0.1:5173/">Technofest</a>
            </div>
            <div class="content">
                ...
                <span>Thanks,</span><h2>The Technofest</h2>
            </div>
            <div class="footer">
                <p>© Copyright 2024 Technofest's .All Rights Reserved</p>
            </div>
        </div>
    </body>
    </html>
...
exports.forgetPassword = async (req, res, next) => {
  try {
    ...
    if (!user) {
      return next(
        new CustomErrors("We cannot find the user with the given email", 404)
      );
    }
